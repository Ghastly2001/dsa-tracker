    ...
    <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4">
      <div className="w-full max-w-sm space-y-8">
        <div className="text-center space-y-1">
          ...
          <h1 className="text-2xl font-bold text-slate-100 tracking-tight">DSA Tracker</h1>
          <p className="text-sm text-slate-500">Sign in to track your DSA progress</p>
        </div>
        ...
        <p className="text-center text-slate-600 text-sm">
          ...
          <Link href="/register" className="text-slate-300 hover:text-amber-400 transition-colors font-medium">
            Create account
          </Link>
        </p>
      </div>
